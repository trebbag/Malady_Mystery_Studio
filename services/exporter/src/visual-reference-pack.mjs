...
export function buildVisualReferencePack(options) {
  ...
  return {
    ...
    workflowRunId: options.workflowRun.id,
    renderingGuideId: options.renderingGuide.id,
    ...(options.renderingGuide.medicalProvenance ? { medicalProvenance: options.renderingGuide.medicalProvenance } : {}),
    generatedAt: options.generatedAt,
    guidancePackVersionIds: options.renderingGuide.guidancePackVersionIds ?? [],
    sourceGuidanceProvenance: options.renderingGuide.sourceGuidanceProvenance ?? [],
